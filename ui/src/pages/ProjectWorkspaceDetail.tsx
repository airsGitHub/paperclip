        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Field label={t("projectWorkspaceDetail.visibility")}>
                <select
                  className="w-full rounded-lg border border-border bg-background px-3 py-2 text-sm outline-none"
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Field label={t("projectWorkspaceDetail.repo_url")}>
                  <input
                    ...
                    placeholder={t("projectWorkspaceDetail.httpsgithubcomorgrepo")}
                  />
                </Field>
                <Field label={t("projectWorkspaceDetail.repo_ref")}>
                  <input
                    ...
                    placeholder={t("projectWorkspaceDetail.originmain")}
                  />
                </Field>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Field label={t("projectWorkspaceDetail.remote_workspace_ref")}>
                  <input
                    ...
                    placeholder={t("projectWorkspaceDetail.workspace123")}
                  />
                </Field>
              </div>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-border bg-card p-5">
            <div className="space-y-1">
              <div className="text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground">{t("projectWorkspaceDetail.workspace_facts")}</div>
              <h2 className="text-lg font-semibold">{t("projectWorkspaceDetail.current_state")}</h2>
            </div>
            <Separator className="my-4" />
            <DetailRow label={t("projectWorkspaceDetail.project")}>
          ...
          <div className="rounded-2xl border border-border bg-card p-5">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              <div className="space-y-1">
                <div className="text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground">{t("projectWorkspaceDetail.workspace_commands")}</div>
