  ...
  return (
    <div>
      ...
      <div className="border-b border-border px-5 py-5 space-y-4">
        ...
        {sourceMode === "local" ? (
          ...
          >
            <input
              ...
              type="text"
              value={importUrl}
              placeholder={t("companyImport.httpsgithubcomownerrepotreemaincompany")}
              onChange={(e) => {
        ...
        <Field label={t("companyImport.target")} hint="Import into this company or create a new one.">
          <select
            className="w-full rounded-md border border-border bg-transparent px-2.5 py-1.5 text-sm outline-none"
            value={targetMode}
            onChange={(e) => {
          ...
          >
            <option value="new">{t("companyImport.create_new_company")}</option>
        ...
        {targetMode === "new" && (
          <Field
            label={t("companyImport.new_company_name")}
          ...
          >
            <input
              ...
              placeholder={t("companyImport.imported_company")}
            />
          </Field>
        )}
