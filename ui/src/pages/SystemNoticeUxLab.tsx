  ...
  return (
    <div className="space-y-6">
      ...
      <LabSection
        id="tones"
        eyebrow="Tone matrix"
        title={t("systemNoticeUxLab.three_tones_two_states")}
        description={t("systemNoticeUxLab.each_tone_pairs_a_unique_icon_and_tone_l")}
      ...
      <LabSection
        ...
        title={t("systemNoticeUxLab.distinct_from_user_and_agent_comments")}
        description={t("systemNoticeUxLab.sidebyside_with_adjacent_comment_types_s")}
      ...
      >
        <div className="space-y-4 rounded-2xl border border-border/70 bg-background/70 p-4">
          ...
          <SystemNotice
            tone="danger"
            label={t("systemNoticeUxLab.system_alert")}
      ...
      <div className="grid gap-5 xl:grid-cols-2">
        <LabSection
          eyebrow="Before"
          title={t("systemNoticeUxLab.todays_nested_treatment")}
          description={t("systemNoticeUxLab.the_same_content_rendered_through_the_ex")}
          accentClassName="bg-[linear-gradient(180deg,rgba(244,63,94,0.05),transparent_28%),var(--background)]"
        >
          <div className="space-y-3 rounded-2xl border border-border/70 bg-background/70 p-4">
            <div className="flex items-start gap-2.5">
              <Avatar size="sm" className="shrink-0">
                <AvatarFallback>{t("systemNoticeUxLab.yo")}</AvatarFallback>
              </Avatar>
              <div className="flex min-w-0 max-w-[85%] flex-col">
                <div className="mb-1 px-1 text-sm font-medium text-foreground">{t("systemNoticeUxLab.you")}</div>
                <div className="min-w-0 max-w-full rounded-2xl bg-muted px-4 py-2.5 text-sm leading-6 text-foreground">
                  <div className="rounded-md border border-red-500/35 bg-red-500/10 px-3 py-2.5 text-sm text-red-950 dark:text-red-100">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="min-w-0">
                        <p className="m-0 font-semibold">{t("systemNoticeUxLab.successful_run_handoff_missing")}</p>
            ...
            <p className="px-1 text-xs text-muted-foreground">
              Author reads as <span className="font-medium text-foreground">{t("systemNoticeUxLab.you")}</span> even though the
        ...
        <LabSection
          eyebrow="After"
          title={t("systemNoticeUxLab.system_notice_replacement")}
          description={t("systemNoticeUxLab.one_container_systemauthored_label_hidde")}
        ...
        >
          <div className="space-y-3 rounded-2xl border border-border/70 bg-background/70 p-4">
            ...
            <p className="px-1 text-xs text-muted-foreground">
              ...
              <span className="font-medium text-foreground">{t("systemNoticeUxLab.details")}</span> only when they need run
      ...
      <Card className="gap-4 border-border/70 bg-background/85 py-0">
        <CardHeader className="px-5 pt-5 pb-0">
          ...
          <CardTitle className="text-lg">{t("systemNoticeUxLab.handoff_to_engineering")}</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-3 px-5 pb-5 pt-0 text-sm text-muted-foreground">
          <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
            <div className="mb-1 font-medium text-foreground">{t("systemNoticeUxLab.component")}</div>
          ...
          <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
            <div className="mb-1 font-medium text-foreground">{t("systemNoticeUxLab.routing_in_issuechatthread")}</div>
            Comments where{" "}
            ...
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[12px]">{t("systemNoticeUxLab.issuechatusermessage")}</code>{" "}
            or assistant bubble.
          </div>
          <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
            <div className="mb-1 font-medium text-foreground">{t("systemNoticeUxLab.accessibility")}</div>
          ...
          <div className="rounded-2xl border border-border/70 bg-background/80 px-4 py-3">
            <div className="mb-1 font-medium text-foreground">{t("systemNoticeUxLab.legacy_fallback")}</div>
            ...
            <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[12px]">{t("systemNoticeUxLab.successfulrunhandoffcommentcallout")}</code>{" "}
