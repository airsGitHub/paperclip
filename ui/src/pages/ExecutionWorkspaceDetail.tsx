        ...
        {activeTab === "services" ? (
          ...
          <div className="space-y-4 sm:space-y-6">
            <Card className="rounded-none">
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div className="text-xs font-medium uppercase tracking-widest text-muted-foreground">{t("executionWorkspaceDetail.general")}</div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <Field label={t("executionWorkspaceDetail.branch_name")} hint="Useful for isolated worktrees">
                      <Input
                        ...
                        placeholder={t("executionWorkspaceDetail.pap946workspace")}
                      />
                    </Field>
                    ...
                    <Field label={t("executionWorkspaceDetail.base_ref")}>
                      <Input
                        ...
                        placeholder={t("executionWorkspaceDetail.originmain")}
                      />
                    </Field>
                  </div>
                  ...
                  <Field label={t("executionWorkspaceDetail.repo_url")}>
                    <Input
                      ...
                      placeholder={t("executionWorkspaceDetail.httpsgithubcomorgrepo")}
                    />
                  </Field>
                </div>
                ...
                <div className="space-y-4">
                  <div className="text-xs font-medium uppercase tracking-widest text-muted-foreground">{t("executionWorkspaceDetail.paths")}</div>
                ...
                <div className="space-y-4">
                  ...
                  <Field label={t("executionWorkspaceDetail.provision_command")} hint="Runs when Paperclip prepares this execution workspace">
                    <Textarea
                      ...
                      placeholder={t("executionWorkspaceDetail.bash_scriptsprovisionworktreesh")}
                    />
                  </Field>
                  ...
                  <Field label={t("executionWorkspaceDetail.teardown_command")} hint="Runs when the execution workspace is archived or cleaned up">
                    <Textarea
                      ...
                      placeholder={t("executionWorkspaceDetail.bash_scriptsteardownworktreesh")}
                    />
                  </Field>
            ...
            <Card className="rounded-none">
              ...
              <CardContent>
              <DetailRow label={t("executionWorkspaceDetail.project")}>
              ...
              <DetailRow label={t("executionWorkspaceDetail.source_issue")}>
                {sourceIssue ? (
