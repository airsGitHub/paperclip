  ...
  return (
    <div className="space-y-6">
      <div className="overflow-hidden rounded-[32px] border border-border/70 bg-[linear-gradient(135deg,rgba(8,145,178,0.10),transparent_28%),linear-gradient(180deg,rgba(245,158,11,0.10),transparent_44%),var(--background)] shadow-[0_30px_80px_rgba(15,23,42,0.10)]">
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_320px]">
          <div className="p-6 sm:p-7">
            ...
            <h1 className="mt-4 text-3xl font-semibold tracking-tight">{t("issueChatUxLab.issue_chat_review_surface")}</h1>
      ...
      <LabSection
        ...
        title={t("issueChatUxLab.rotating_reasoning_text")}
        description={t("issueChatUxLab.isolated_ticker_that_cycles_sample_reaso")}
      ...
      <LabSection
        ...
        title={t("issueChatUxLab.working_worked_header_verb")}
          ...
          <div className="rounded-xl border border-border/60 bg-accent/10 p-4">
            ...
            <div className="flex items-center gap-2.5 rounded-lg px-1 py-2">
              <span className="inline-flex items-center gap-2 text-sm font-medium text-foreground/80">
                ...
                <span className="shimmer-text">{t("issueChatUxLab.working")}</span>
              </span>
      ...
      <LabSection
        ...
        title={t("issueChatUxLab.live_execution_thread")}
        description={t("issueChatUxLab.shows_the_fully_active_state_timeline_ev")}
      ...
      <LabSection
        ...
        title={t("issueChatUxLab.pending_message_bubble")}
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <LabSection
          ...
          title={t("issueChatUxLab.durable_comments_and_feedback")}
          description={t("issueChatUxLab.shows_the_postrun_state_assistant_commen")}
        ...
        <div className="space-y-6">
          <LabSection
            ...
            title={t("issueChatUxLab.empty_state_and_disabled_composer")}
            description={t("issueChatUxLab.keeps_the_message_area_visible_even_when")}
          ...
          <Card className="gap-4 border-border/70 bg-background/85 py-0">
            <CardHeader className="px-5 pt-5 pb-0">
              ...
              <CardTitle className="text-lg">{t("issueChatUxLab.what_to_evaluate_on_this_page")}</CardTitle>
              <CardDescription>
